...
class Panel_admin extends CI_Controller {
	...
	public function verifikasi($aksi='', $id='')
	{
		...
		if(!isset($ceks)) {
			...
			$data['v_siswa']  		= $this->db->get_where('tbl_siswa', array('jk'=>'l','verifikasi_data'=>'SD'));
			$data['v_thn']				= $thn;
	...
	public function verifikasiSDPI($aksi='', $id='')
	{
		$ceks = $this->session->userdata('un@sman1_belitang');
		if(!isset($ceks)) {
			redirect('panel_admin/log_in');
			...
			$this->db->like('tgl_siswa', "$thn", 'after');
			$this->db->order_by('id_siswa', 'DESC');
			$data['v_siswa']  		= $this->db->get_where('tbl_siswa', array('jk'=>'p','verifikasi_data'=>'SD'));
			$data['v_thn']				= $thn;

					$this->load->view('admin/header', $data);
					$this->load->view('admin/verifikasi/verifikasiSDPI', $data);
					$this->load->view('admin/footer');
		}
	}
	public function verifikasiSMPPA($aksi='', $id='')
	{
		$ceks = $this->session->userdata('un@sman1_belitang');
		if(!isset($ceks)) {
			redirect('panel_admin/log_in');
			...
			$this->db->like('tgl_siswa', "$thn", 'after');
			$this->db->order_by('id_siswa', 'DESC');
			$data['v_siswa']  		= $this->db->get_where('tbl_siswa', array('jk'=>'l','verifikasi_data'=>'SMP'));
			$data['v_thn']				= $thn;

					$this->load->view('admin/header', $data);
					$this->load->view('admin/verifikasi/verifikasiSMPPA', $data);
					$this->load->view('admin/footer');
		}
	}
	public function verifikasiSMPPI($aksi='', $id='')
	{
		$ceks = $this->session->userdata('un@sman1_belitang');
		if(!isset($ceks)) {
			redirect('panel_admin/log_in');
			...
			$this->db->like('tgl_siswa', "$thn", 'after');
			$this->db->order_by('id_siswa', 'DESC');
			$data['v_siswa']  		= $this->db->get_where('tbl_siswa', array('jk'=>'p','verifikasi_data'=>'SMP'));
			$data['v_thn']				= $thn;

					$this->load->view('admin/header', $data);
					$this->load->view('admin/verifikasi/verifikasiSMPPI', $data);
					$this->load->view('admin/footer');
		}
	}
	public function verifikasiLanjutan($aksi='', $id='')
	{
		$ceks = $this->session->userdata('un@sman1_belitang');
		if(!isset($ceks)) {
			redirect('panel_admin/log_in');
			...
			$this->db->like('tgl_siswa', "$thn", 'after');
			$this->db->order_by('id_siswa', 'DESC');
			$data['v_siswa']  		= $this->db->get_where('tbl_siswa', array('verifikasi_data'=>'lanjutan'));
			$data['v_thn']				= $thn;

					$this->load->view('admin/header', $data);
					$this->load->view('admin/verifikasi/verifikasiLanjutan', $data);
					$this->load->view('admin/footer');
		}
	}
