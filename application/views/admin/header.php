...
<head>
	...
	<!-- /core JS files -->
	<?php
	if ($sub_menu == "" or $sub_menu == "profile" or $sub_menu == "ubah_pass" or $menu == "laporan" or $sub_menu == "statistik" or $sub_menu == "statistikSDPI") {?>
	<!-- Theme JS files -->
	...
	<?php
	if ($sub_menu == "verifikasi" or $sub_menu == "verifikasiSDPI" or $sub_menu == "verifikasiSMPPI" or $sub_menu == "set_pengumuman" or $sub_menu == "scan") {?>
		<!-- Theme JS files -->
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'verifikasiSDPA' OR $sub_menu == 'edit_materi'){echo 'active';} ?>"><a href="panel_admin/verifikasi"><i class="icon-file-check"></i> <span>Pembayaran SD PA</span></a></li>
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'verifikasiSDPI' OR $sub_menu == 'edit_materi'){echo 'active';} ?>"><a href="panel_admin/verifikasiSDPI"><i class="icon-file-check"></i> <span>Pembayaran SD PI</span></a></li>
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'verifikasiSMPPA' OR $sub_menu == 'edit_materi'){echo 'active';} ?>"><a href="panel_admin/verifikasiSMPPA"><i class="icon-file-check"></i> <span>Pembayaran SMP PA</span></a></li>
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'verifikasiSMPPI' OR $sub_menu == 'edit_materi'){echo 'active';} ?>"><a href="panel_admin/verifikasiSMPPI"><i class="icon-file-check"></i> <span>Pembayaran SMP PI</span></a></li>
								<li class="<?php if($menu == 'panel_admin' AND $sub_menu == 'verifikasiLanjutan' OR $sub_menu == 'edit_materi'){echo 'active';} ?>"><a href="panel_admin/verifikasiLanjutan"><i class="icon-file-check"></i> <span>Pembayaran Lanjutan</span></a></li>
