...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
		...
		<div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">NIK <span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon">
              <input type="text" name="nik_wali" class="form-control bg-blue" placeholder="NIK Wali"  maxlength="100" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nik_wali"]' >
              <i class="fa fa-user" style="margin-left:15px;"></i>
		...
		<div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Tempat Lahir <span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon">
              <input type="text" name="tempat_lahir_wali" class="form-control bg-blue" placeholder="Tempat Lahir Wali"  maxlength="100" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-tempat_lahir_wali"]' >
              <i class="fa fa-user" style="margin-left:15px;"></i>
		...
		<div class="form-group" style="padding-bottom:30px;">
            <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Tanggal Lahir <span class="text-danger">*</span></label>
            <div class="col-sm-9 prepend-icon">
              <input type="text" name="tgl_lahir_wali" class="form-control bg-blue" placeholder="Tempat Lahir Wali"  maxlength="100" data-parsley-group="block2" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-tgl_lahir_wali"]' >
              <i class="fa fa-user" style="margin-left:15px;"></i>
